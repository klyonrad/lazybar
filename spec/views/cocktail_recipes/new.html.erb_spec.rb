...
RSpec.describe "cocktail_recipes/new", type: :view do
  before(:each) do
    assign(:cocktail_recipe, CocktailRecipe.new(
      :name => "MyString",
      :cost => "9.99",
      :selling_price => "9.99",
  ...
  it "renders new cocktail_recipe form" do
    render

    assert_select "form[action=?][method=?]", cocktail_recipes_path, "post" do
